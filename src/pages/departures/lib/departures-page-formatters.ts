...
export const DEPARTURE_SUBJECT_KIND_LABELS: Record<SubjectKind, string> = {
  cashback: 'Кэшбэк',
  money: 'Деньги',
  other: 'Прочее',
  payment: 'Платёж',
...
export const DEPARTURE_SUBJECT_KIND_OPTIONS: SubjectKind[] = [
  'product',
  'money',
  'salary',
  'cashback',
...
export const DEPARTURES_SORT_OPTIONS: CollectionSortOption[] = [
