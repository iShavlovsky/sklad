...
import type {
  ...
  ScannerRuntimeDecodedValueInput,
...
function getCurrentScannerControlOwner(
  dependencies: ScannerRuntimeControllerDependencies
): BufferControlOwner | null {
...
function resolveDecodedValueSource(
  dependencies: ScannerRuntimeControllerDependencies,
...
function setScannerRuntimeError(
  dependencies: ScannerRuntimeControllerDependencies,
  input: {
    code:
      | 'permission-denied'
...
function clearScannerRuntimeError(
  dependencies: ScannerRuntimeControllerDependencies
): void {
  const scannerSessionState = dependencies.scannerSessionStore.getState();
